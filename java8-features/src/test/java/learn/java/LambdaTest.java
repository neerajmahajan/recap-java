...
public class LambdaTest {
	...
	public void testObjectSortingUsingLambdaExpression() {
		...
		Employee[] employees = { new Employee("Rohit", 35, 12.5f), new Employee("Neeraj", 35, 12.5f),
	...
	public void testObjectSortingUsingArbitaryObjectMethodReference() {
		...
		Employee[] employees = { new Employee("Rohit", 35, 12.5f), new Employee("Neeraj", 35, 12.5f),
				new Employee("Vishal", 29, 15.2f) };
		// How below assignment works when the Comparator compareTo method
		// expect two arguments, however isEqualBigSmall method from Employee
		// class take only one argument ???
		// This article provide explanation for this...
